...
export function GlobeDemo() {
  ...
  return (
    <div className="flex max-lg:hidden flex-row w-[50vw] items-center justify-center h-screen md:h-auto  relative">
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full md:h-[40rem]">
        <motion.div
          ...
          <h2 className="text-center text-lg md:text-4xl font-bold text-white">
            Track Orders with Cybership OrderStream
          </h2>
          <p className="text-center text-base md:text-md font-normal text-neutral-200 max-w-md mt-2 mx-auto">
            Stay updated with real-time order statuses. Our platform simplifies
            tracking for seamless customer experiences.
          </p>
        </motion.div>
        <div className="absolute w-full -bottom-12 h-72 md:h-full z-10">
